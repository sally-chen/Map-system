 ...
 * xworldenient), and draw with the current line style, colour and width.
 */
...
void drawtext(float xc, float yc, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX, bool map = true);
void drawtext(const t_point& text_center, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX, bool map = true);
void drawtext(const t_point& text_center, const std::string& text, const t_bound_box& bounds, bool map = true);
void drawtext(
        const t_point& text_center, const std::string& text, const t_bound_box& bounds, float tolerance, bool map = true);

void drawtext_in(const t_bound_box& bbox, const std::string& text, bool map = true);
void drawtext_in(const t_bound_box& bbox, const std::string& text, float tolerance, bool map = true);
